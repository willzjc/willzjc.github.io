...
class db_interface():
    ...
    def db_save_df(self, df_array):
        ...
        container = {}
        metrics = ['id', 'title', 'link', 'make', 'model', 'series', 'transmission', 'age', 'age_rating', 'milage',
                   'milage_rating', 'price', 'price_rating']

        for metric in metrics:
            container[metric] = (df_array[metric])

        self.db_save(container['id'], container['title'], container['link'], container['make'], container['model'],
                     container['series'],
                     container['transmission'], container['age'], container['age_rating'], container['milage'],
                     container['milage_rating'],
    ...
    def db_save(self, id, title, link, make, model, series, transmission, age, age_rating, milage, milage_rating, price,
                price_rating):
