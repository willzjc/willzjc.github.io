...
var getMetricText = function () {
    switch (this.measureFunc) {
        case 'Count':
            return "Number of " + this.recordName;
        case 'Sum'  :
            return "Total " + this.measureSummary.summaryName + " of " + this.recordName;
        case 'Avg'  :
            return "Average " + this.measureSummary.summaryName + " of " + this.recordName;
    }
}
...
var measureMetricInfo = function () {
    ...
    switch (this.browser.measureFunc) {
        case 'Count':
            alternative = "Sum or Average of a numeric attribute";
            break;
        case 'Sum':
            alternative = "Number of " + this.browser.recordName + ", or Average of a numeric attribute";
            break;
        case 'Avg':
            alternative = "Number of " + this.browser.recordName + ", or Sum of a numeric attribute";
            break;
    }
...
var aggrDescription = function (aggr, encodingIcon) {
    ...
    switch (this.measureFunc) {
        case 'Sum'  :
            simpleMeasure = "Total " + this.measureSummary.summaryName;
            break;
        case 'Avg'  :
            simpleMeasure = "Average " + this.measureSummary.summaryName;
            break;
    }
...
var _material = {
    _contextFeatures: {
        ...
        CategoricalSummary: {
            ...
            v: {
                summaries: function (summary) {
                    return summary.type === "categorical";
                }
            },
            weight: 20,
            multiplier: 1.2
        ...
        CategoricalMultiValSummary: {
            ...
            v: {
                summaries: function (summary) {
                    return summary.type === "categorical" && summary.isMultiValued;
                }
            },
            weight: 40
        },
        ...
        NumberSummary: {
            ...
            v: {
                summaries: function (summary) {
                    return summary.type === "interval" && summary.scaleType !== "time";
                }
            },
            weight: 30
        },
        ...
        SummaryWithMissingValues: {
            ...
            v: {
                summaries: function (summary) {
                    return summary.missingValueAggr.records.length > 0;
                }
            },
            weight: 47
        },
        ExpandableSummary: {
            ...
            v: {
                summaries: function (summary) {
                    return !summary.areAllCatsInDisplay();
                }
            },
            weight: 20
        },
        SortableSummary: {
            ...
            v: {
                summaries: function (summary) {
                    return summary.configRowCount > 0 && !summary.catSortBy_Active.no_resort;
                }
            },
            weight: 22
        },
        ...
        SummaryOpenConfig: {
            ...
            v: {
                summaries: function (summary) {
                    return summary.DOM.root.attr("showConfig") === "true";
                }
            },
            weight: 50,
        ...
        NotAverageMeasure: {
            ...
            v: function () {
                return this.browser.measureFunc !== "Avg";
            },
            weight: 10,
        ...
        RecordTextSearch: {
            ...
            v: function () {
                return this.recordDisplay.textSearchSummary !== null;
            },
            weight: 35
        },
        RecordsWithDetailToggle: {
            ...
            v: function () {
                return this.recordDisplay.detailsToggle !== "off";
            },
            weight: 25
        },
        RecordDisplayAsMap: {
            ...
            v: function () {
                return this.recordDisplay.config.geo;
            },
            weight: 55
        },
        RecordDisplayAsNetwork: {
            ...
            v: function () {
                return this.recordDisplay.config.linkBy.length > 0;
            },
            weight: 55
        },
        RecordDisplayAsList: {
        ...
        AnyFiltered: {
            ...
            v: function () {
                return this.browser.isFiltered();
            },
            weight: 40,
            fixBy: 'T_SelectFilter'
        },
        ...
        AuthoringMode: {
            ...
            v: function () {
                return this.browser.authoringMode;
            },
            weight: 10,
            fixBy: 'T_EnableAuth',
        },
        ...
        "Breadcrumb": {
            ...
            info: function (DOM) {
                ...
                switch (DOM.classList[1]) {
                    case "crumbMode_Compare_A":
                        x = "<i class='fa fa-lock'></i> locked-";
                        break;
                    case "crumbMode_Compare_B":
                        x = "<i class='fa fa-lock'></i> locked-";
                        break;
                    case "crumbMode_Compare_C":
                        x = "<i class='fa fa-lock'></i> locked-";
                        break;
                    case "crumbMode_Filter":
                        x = "<i class='fa fa-filter'></i> filtered-";
                        break;
                    default:
                        x = "<i class='fa fa-mouse-pointer'></i> highlighted-";
                        break;
                }
                ;
...
//            " satisfies ",
        ...
        T_FilterOr: {
            ...
            tAnswer: {
                ...
                deactivate: function () {
                    this.context.HighlightedDOM[0].removeAttribute("mouseOver");
                },
            }
        },
        T_FilterNot: {
        ...
        T_RecordTextSearch: {
            q: function () {
                return "Select " + this.browser.recordName + " by text search";
            },
            actions: "Explore+Select",
        ...
        T_ExploreMissingVal: {
            q: function () {
                return "Explore " + this.browser.recordName + " with missing/invalid values";
            },
            actions: "Explore+Select",
            topics: "Aggregate",
        ...
        T_ClearFilters: {
            q: function () {
                return "Clear all filters / Show all " + this.browser.recordName;
            },
        ...
        T_RecSortRev: {
            q: function () {
                return "Sort " + this.browser.recordName + " in reverse";
            },
        ...
        T_RecSortChange: {
            q: function () {
                return "Change sorting criteria of " + this.browser.recordName;
            },
            actions: "Explore+Sort",
            topics: "Record Panel",
