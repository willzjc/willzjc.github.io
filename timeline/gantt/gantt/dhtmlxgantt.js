...
window.Gantt = {_seed: 0}, Gantt.plugin = function (t) {
    ...
    var t = {version: "4.0.0"};
    t = {version: "4.0.0"}, t.event = function (t, e, i) {
        ...
        dragStart: function (e, i) {
            ...
            if (!this.config.marker && !this.config.started) {
                var i = this.getPosition(e), n = i.x - this.config.pos.x, a = i.y - this.config.pos.y,
        ...
        this.defined(this.config.dnd_sensitivity) && (e.config.sensitivity = this.config.dnd_sensitivity), e.attachEvent("onBeforeDragStart", this.bind(function (i, n) {
            ...
            var o = (r.x, r.y), _ = document.documentElement.scrollTop || document.body.scrollTop,
                d = document.documentElement.scrollLeft || document.body.scrollLeft,
                l = document.elementFromPoint(r.x - d + 1, o - _), h = this.locate(l), c = this.getTask(e.config.id);
            if (this.isTaskExists(h) || (h = e.lastTaskOfLevel(t.config.order_branch_free ? c.$level : 0), h == e.config.id && (h = null)),
                    this.isTaskExists(h)) {
                var u = t._get_position(l), g = this.getTask(h);
        ...
        getSum: function (t, e, i) {
            ...
            var o = i.length - 1, _ = i[o], d = t.date.add(_, e.step, e.unit);
        ...
        var l = a[a.length - 1].direction, h = t._render_link_arrow(i[i.length - 1], l);
        ...
        var n = document.createElement("div"), a = t._drawer, s = e.y, r = e.x, o = t.config.link_arrow_size,
            _ = t.config.row_height, d = "gantt_link_arrow gantt_link_arrow_" + i;
        switch (i) {
            case a.dirs.right:
                s -= (o - _) / 2, r -= o;
                break;
        ...
        h.attachEvent("onBeforeDragStart", t.bind(function (i, n) {
            ...
            n(o.marker, _);
            var d = t._is_link_drop_area(s), l = t._link_target_task, c = t._link_landing,
        ...
        var d = e.$index % 2 !== 0, l = t.templates.task_row_class(e.start_date, e.end_date, e),
        ...
        if (o.link_source_id == n && a.push("gantt_link_source"),
            ...
            var _ = o.link_source_id, d = o.link_source_start, l = o.link_target_start, h = t.isLinkAllowed(_, n, d, l),
                c = "";
    ...
    t._is_flex_task = function (t) {
        ...
        return t.defined(i) || (i = this.getLink(e)), this.callEvent("onBeforeLinkUpdate", [e, i]) === !1 ? !1 : (this._lpull[e] = i, this._sync_links(), this._render_link(e), this.callEvent("onAfterLinkUpdate", [e, i]),
            !0)
        ...
        if (!t.skin || e) for (var i = document.getElementsByTagName("link"), n = 0; n < i.length; n++) {
    ...
    t._resolve_default_mapping = function (t) {
        ...
        for (var s = this._get_typed_lightbox_config(this.getLightboxType()), r = 0; r < s.length; r++) {
            ...
            if (this.form_blocks[o.type]) {
                var _ = document.getElementById(o.id).nextSibling, d = this.form_blocks[o.type],
                    l = t._resolve_default_mapping(s[r]), h = this.defined(n[l]) ? n[l] : o.default_value;
        ...
        getTimePicker: function (e, i) {
            ...
            render: function (t) {
                ...
                var h = n[l.start_date] || new Date, c = n[l.end_date] || t.calculateEndDate(h, 1);
                ...
                var h = t._resolve_default_mapping(n), c = {start_date: new Date(d), end_date: new Date(l)};
            ...
            render: function (t) {
                ...
                var o = a, _ = e.getElementsByTagName("select"), d = e.getElementsByTagName("input"), l = d[1],
                    h = [d[0], d[2]], c = e.getElementsByTagName("span")[0], u = a._time_format_order;
    ...
    t.form_blocks.time_optional = t._extend_to_optional(t.form_blocks.time),t.dataProcessor = function (e) {
        ...
        setTransactionMode: function (t, e) {
            ...
            if (e) {
                ...
                if ("GET" == this._tMode) t.ajax.get(s + (-1 != s.indexOf("?") ? "&" : "?") + this.serialize(e, i), a); else if ("POST" == this._tMode) t.ajax.post(s, this.serialize(e, i), a); else if ("REST" == this._tMode) {
                    ...
                    t.ajax.query({url: o, method: d, headers: this._headers, data: _, callback: a})
                }
                this._waitMode++
            }
            ...
            if (window.JSON) try {
                var a = JSON.parse(i.xmlDoc.responseText), s = a.action || this.getState(n) || "updated",
                    r = a.sid || n[0], o = a.tid || n[0];
        ...
        var e = ["width", "height", "paddingTop", "paddingBottom", "paddingLeft", "paddingRight", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"],
            i = {boxSizing: "border-box" == t.boxSizing};
        ...
        function e(e) {
            ...
            if (a && Math.abs(a) > Math.abs(s)) {
                ...
                var d = t.$scroll_ver.scrollTop, l = t.$scroll_ver.scrollTop + 30 * r;
        ...
        var t = this._get_grid_width(), e = Math.max(this._x - t, 0),
            ...
            a = Math.max(this.$task_data.offsetWidth - n, 0), s = this.config.row_height * this._order.length,
            r = this._get_resize_options(), o = this._scroll_hor = r.x ? !1 : a > e,
            _ = this._scroll_ver = r.y ? !1 : s > i, d = {
    ...
    },t.config || (t.config = {}),t.config || (t.config = {}),t.templates || (t.templates = {}),function () {
        t.mixin(t.config, {
            links: {
                finish_to_start: "0",
